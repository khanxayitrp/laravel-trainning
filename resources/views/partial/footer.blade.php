<footer class="footer">
        <div class="row lg-menu">
            <div class="container">
                <div class="col-md-4 col-sm-4"><img src="{{url('/')}}/assets/img/footer-logo.png" class="img-responsive" alt=""/>
                </div>
    ...
    <script type="text/javascript" src="{{url('/')}}/assets/plugins/js/viewportchecker.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/plugins/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/plugins/js/bootsnav.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/plugins/js/select2.min.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/plugins/js/wysihtml5-0.3.0.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/plugins/js/bootstrap-wysihtml5.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/plugins/js/datedropper.min.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/plugins/js/dropzone.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/plugins/js/loader.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/plugins/js/owl.carousel.min.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/plugins/js/slick.min.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/plugins/js/gmap3.min.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/plugins/js/jquery.easy-autocomplete.min.js"></script>
