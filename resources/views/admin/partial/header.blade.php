<head>
    ...
    <link rel="stylesheet" href="{{url('/')}}/admin_assets/vendor/charts/chartist-bundle/chartist.css">
    ...
    <link rel="stylesheet" href="{{url('/')}}/admin_assets/vendor/charts/c3charts/c3.css">
    <link rel="stylesheet" href="{{url('/')}}/admin_assets/vendor/fonts/flag-icon-css/flag-icon.min.css">
